...
export class LoginControllerBase {
  ...
  async create(
    @common.Body() data: LoginCreateInput,
    ...
    if (invalidAttributes.length) {
      ...
      throw new errors.ForbiddenException(
        `providing the properties: ${properties} on ${"Login"} creation is forbidden for roles: ${roles}`
      );
    }
  ...
  async update(
    ...
    if (invalidAttributes.length) {
      ...
      const roles = userRoles
        ...
        .join(",");
      throw new errors.ForbiddenException(
        `providing the properties: ${properties} on ${"Login"} update is forbidden for roles: ${roles}`
      );
    }
    try {
